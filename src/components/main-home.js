        ...
        <section>
          ...
          <article className="article-half flex-row-between flex-wrap flex-align-items-center">
            <div className="half-widget home-size flex-column-between flex-wrap flex-align-items-center" data-aos="zoom-in" data-aos-duration="1500">
              ...
              <a className="btn btn-black btn-shadow" href="/project">Click Here</a>
            </div>
            ...
            <div className="half-widget home-size flex-column-between flex-wrap flex-align-items-center" data-aos="zoom-in" data-aos-duration="1500">
              ...
              <a className="btn btn-black btn-shadow" href="/friends">Click Here</a>
            </div>
            ...
            <div className="half-widget home-size flex-column-between flex-wrap flex-align-items-center" data-aos="zoom-in" data-aos-duration="1500">
              ...
              <a className="btn btn-black btn-shadow" href="https://www.linkedin.com/in/stephan-gordijn-062636171/" target="_blank" rel="noopener noreferrer">Click Here</a>
            </div>
            ...
            <div className="half-widget home-size flex-column-between flex-wrap flex-align-items-center" data-aos="zoom-in" data-aos-duration="1500">
              ...
              <a className="btn btn-black btn-shadow" href="https://github.com/SGordijn" target="_blank" rel="noopener noreferrer">Click Here</a>
            </div>
          </article>
        </section>
      </main>
